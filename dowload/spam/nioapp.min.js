var NioApp = function(n, d) {
    ...
    return d.fn.exists = function() {
        return 0 < this.length
    }
    ,
    d.fn.csskey = function(e, t) {
        for (var a = t ? t + "-" : "", o = e ? e.split(" ") : "", s = 0; s < o.length; s++)
            o[s] = a + o[s];
    ...
    n.hexRGB = function(e, t) {
        ...
        if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(e))
            return e = [(e = "0x" + (e = 3 === (e = e.substring(1).split("")).length ? [e[0], e[0], e[1], e[1], e[2], e[2]] : e).join("")) >> 16 & 255, e >> 8 & 255, 255 & e].join(","),
            1 <= t ? "rgba(" + e + ")" : "rgba(" + e + "," + t + ")";
    ...
    n.BreakClass = function(e, t, a) {
        ...
        }, i.timeOut) : d(o).removeClass(i.classAdd)
    }
    ,
    n.Passcode = function(e, t) {
        ...
        d(e).exists() && d(e).on("click", function(e) {
            var t = d(this)
              ...
              , a = d("#" + a);
            e.preventDefault(),
            a.hasClass(o.showClass) ? (t.add(a).addClass(o.hideClass).removeClass(o.showClass),
            a.attr("type", "password")) : (t.add(a).addClass(o.showClass).removeClass(o.hideClass),
            a.attr("type", "text"))
        })
    }
    ,
    ...
    n.AddInBody = function(e, t) {
        ...
        d("." + t.prefix + a).exists() && !s.hasClass(e) && s.addClass(e)
    }
    ,
    n.Toggle = {
        trigger: function(e, t) {
            ...
            a.hasClass(o.content) ? (t.removeClass(o.active),
            (1 == o.toggle ? a.slideUp(o.speed) : a).removeClass(o.content)) : (t.addClass(o.active),
            (1 == o.toggle ? a.slideDown(o.speed) : a).addClass(o.content)),
        ...
        dropMenu: function(e, t) {
            ...
            e.slideToggle(t.speed).find("." + t.child).slideUp(t.speed),
            a.toggleClass(t.active).siblings().removeClass(t.active).find("." + t.child).slideUp(t.speed)
        },
        closeProfile: function(e) {
            var t = d(e).find(".nk-profile-toggle.active")
              , e = d(e).find(".nk-profile-content.expanded");
            t.exists() && (t.removeClass("active"),
    ...
    n.BS.popover = function(e) {
        d(e).exists() && "function" == typeof d.fn.popover && d(e).popover()
    }
    ,
    ...
    n.BS.modalfix = function(e) {
        e = e || ".modal";
        d(e).exists() && "function" == typeof d.fn.modal && d(e).on("shown.bs.modal", function() {
    ...
    n.Picker.date = function(e, t) {
        d(e).exists() && "function" == typeof d.fn.datepicker && d(e).each(function() {
            var e = d(this).data("date-format")
              ...
              , e = t ? l(e, t) : e;
            d(this).datepicker(e).on("changeDate", function(e) {
