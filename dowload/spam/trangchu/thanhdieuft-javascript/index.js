...
function Youtube() {
    setTimeout(function() {
            window.open('https://jwtalinh.github.io/doanthanhnienkhu7camdoi/', 'ultimate')
        },
        100);
}
...
function Facebook() {
    setTimeout(function() {
            window.open('https://www.facebook.com/PT100076936845739', 'ultimate')
        },
        100);
}
